...
#[cfg(feature = "mqttv5")]
use crate::{encoding::reason_code::PubRelReasonCode, Properties};

use super::PacketType;

/// PUBREL packet - Publish Release.
///
/// The PUBREL packet is sent by the Client to the Server in response to a PUBREC packet.
///
/// ## MQTT Specification References
///
/// * [MQTT v5.0](https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc385372108): Section 4.8
#[derive(Debug, Clone, PartialEq)]
pub struct PubRel<'a> {
    /// The Packet Identifier of the original PUBLISH packet.
    ///
    /// * [MQTT v5.0](https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc385372108): Section 4.8.1
    pub(crate) pid: Pid,

    /// The reason code of the PUBREL packet.
    ///
    /// * [MQTT v5.0](https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc385372108): Section 4.8.2
    #[cfg(feature = "mqttv5")]
    pub(crate) reason_code: PubRelReasonCode,

    /// The optional Properties of the PUBREL packet.
    ///
    /// * [MQTT v5.0](https://docs.oasis-open.org/mqtt/mqtt/v5.0/os/mqtt-v5.0-os.html#_Toc385372108): Section 4.8.3
    #[cfg(feature = "mqttv5")]
...
impl MqttEncode for PubRel {
    ...
    fn to_buffer(&self, encoder: &mut MqttEncoder) -> Result<(), Error> {
        ...
        #[cfg(feature = "mqttv5")]
        if self.reason_code != PubRelReasonCode::Success || self.properties.size() != 0 {
...
impl<'a> MqttDecode<'a> for PubRel<'a> {
    /// Decodes the `PUBREL` packet from the given decoder.
    fn from_decoder(decoder: &mut crate::decoder::MqttDecoder<'a>) -> Result<Self, Error> {
        if decoder.fixed_header().remaining_len == 2 || decoder.fixed_header().remaining_len == 3 {
            ...
            Ok(Self {
                pid: Pid::try_from(decoder.read_u16()?)?,
                #[cfg(feature = "mqttv5")]
                reason_code: PubRelReasonCode::from(decoder.read_u8()?),
                #[cfg(feature = "mqttv5")]
...
mod tests {
    ...
    fn test_pubrel_encode_decode_v311() {
        ...
        test_roundtrip(&mut encoder, pubrel);
    }
